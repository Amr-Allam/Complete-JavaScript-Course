...
//     .filter(age => age >= 18);
//   const average = humanAges.reduce((acc, cur) => acc + cur) / humanAges.length;
//   console.log(`Dogs in humane ages:`, humanAges);
...
// 6
const allAverage10 = breeds.every(dog => dog.averageWeight >= 10);

// 7
const activeDog = breeds.some(dog => dog.activities.length >= 3);

// BONUS
const heaviestAverageWeightFetch = Math.max(
  ...breeds
...
//     sarahsDog.curFood > sarahsDog.recommendedFood ? 'much' : 'liitle'
//   }`
// );
...
//     ownersEatTooMuch2.push(dog.owners);
//   }
//   if (dog.curFood < dog.recommendedFood * 0.9) {
//     ownersEatTooLittle2.push(dog.owners);
//   }
// });

// console.log(ownersEatTooMuch);
// console.log(ownersEatTooLittle);
// console.log(ownersEatTooMuch2.flat());
// console.log(ownersEatTooLittle2.flat());
